...
/**
 * This file is based on the LtiLaunchData object in 
 * https://github.com/kstateome/lti-launch
 * 
 * @author kstateome
 * @see edu.ksu.lti.model.LtiLaunchData
 * @license LGPL
 */
...
public class LtiLaunchData {
    ...
    public void setRoles(String roles) {
        ...
        this.rolesList = Arrays.stream(roles.split(","))
                .map(role -> mapRole(role))
                .filter(role -> role != null)
                .collect(Collectors.toCollection(ArrayList::new));
    }

    private InstitutionRole mapRole(String role) {
        try {
            return InstitutionRole.fromString(role);
        }
    ...
    private static String combineName(String fullName, String givenName,
            String familyName) {
